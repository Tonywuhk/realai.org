...
where \\(p(\theta)\\) and \\(q(\theta)\\) are the prior and posterior of the weights, respectively. [Fortunato et al. (2017)](https://arxiv.org/abs/1704.02798) extended this approach to recurrent neural networks:
