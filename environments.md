...
[ViZDoom](http://vizdoom.cs.put.edu.pl/) is a Doom-based platform that allows AI bots to play Doom using only the screen buffer. It is primarily intended for research in DRL.
